...
sig schedule{
	...
	(all travel : travels | no task1 : tasks | overlapped[travel.time_slot, task1.time_slot])	        and
	(all travel : travels | no u : travels | overlapped[travel.time_slot, u.time_slot])             
}
